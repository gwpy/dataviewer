...
# -----------------------------------------------------------------------------
#
# GWpy DataViewer documentation build configuration file, created by
...
from gwpy.toolkits.dataviewer import version as dataviewer_version
...
version = dataviewer_version.version
# The full version, including alpha/beta/rc tags.
release = dataviewer_version.version
...
# of the sidebar.
#html_logo = 'dataviewer_white_24.png'
...
def linkcode_resolve(domain, info):
    ...
    fn = os.path.relpath(fn, start=os.path.dirname(dataviewer.__file__))
    if fn.startswith(os.path.pardir):
        return None

    tag = dataviewer_version.git_tag or dataviewer_version.git_branch
    return ("http://github.com/gwpy/dataviewer/tree/%s/dataviewer/%s%s"
            % (tag, fn, linespec))
