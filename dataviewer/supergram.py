...
__all__ = ['SuperSpectrogramMonitor']
...
class SuperSpectrogramMonitor(TimeSeriesMonitor):
    """Monitor some spectra
    """
    type = 'superspectrogram'
    ...
    def __init__(self, *channels, **kwargs):
        ...
        super(SuperSpectrogramMonitor, self).__init__(*channels,
                                                      **kwargs)
